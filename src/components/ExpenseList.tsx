            ...
            {filteredExpenses.map((exp) => (
              ...
              >
                <div className="flex items-center gap-3.5 min-w-0">
                  ...
                  className="w-10 h-10 rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-400 dark:border-zinc-800 flex-shrink-0 relative group/thumb cursor-pointer"
                      title="View receipt"
                    >
